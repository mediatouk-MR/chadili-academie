...
const ar: Dict = {
  ...
  courses: {
    ...
    items: [
      {
        key: "cake",
        title: "شعبة كيك ديزاين",
        desc: "تخصص الشيف عواطف — من الأساسيات إلى الكيك الطابقي الفاخر للأعراس والمناسبات.",
        modules: [
          "مدخل إلى فن تصميم الكيك (Cake Design)",
          "المواد الأولية وأدوات التزيين",
          "تحضير الكيك الأساسي والحشوات",
          "تسوية الكيك وتغطيته (Ganache / Buttercream)",
          "العجينة السكرية (Fondant) وتقنيات التغطية",
          "التزيين بالكريمة والزخارف",
          "تشكيل الورود والزهور السكرية",
          "الكيك الطابقي وكيك الأعراس والمناسبات",
          "الألوان، الرسم، واللمسات الذهبية",
          "التقديم، التصوير، والتسويق",
          "حساب التكلفة والتسعير",
          "التطبيق العملي والمشروع النهائي",
        ],
        modes: ["presentiel", "distance"],
        icon: "PaintBrush",
        video: "/videos/course-cake.mp4",
        poster: "/videos/course-cake-poster.jpg",
      },
      {
        key: "maroc",
...
const fr: Dict = {
  ...
  courses: {
    ...
    title: "Nos quatre filières de formation",
    ...
    items: [
      {
        key: "cake",
        title: "Filière Cake Design",
        desc: "La spécialité de Chef Awatif — des bases aux cakes à étages luxueux pour mariages et grandes occasions.",
        modules: [
          "Introduction à l'art du Cake Design",
          "Matières premières et outils de décoration",
          "Préparation du cake de base et des garnitures",
          "Lissage et couverture du cake (ganache / buttercream)",
          "Pâte à sucre (fondant) et techniques de couverture",
          "Décoration à la crème et motifs",
          "Réalisation de roses et fleurs en sucre",
          "Cakes à étages pour mariages et grandes occasions",
          "Couleurs, peinture et touches dorées",
          "Présentation, photographie et marketing",
          "Calcul du coût et tarification",
...
const en: Dict = {
  ...
  courses: {
    eyebrow: "Our Tracks",
    title: "Our four training tracks",
    ...
    items: [
      {
        key: "cake",
        title: "Cake Design Track",
        desc: "Chef Awatif's specialty — from the basics to luxurious tiered cakes for weddings and special occasions.",
        modules: [
          "Introduction to the art of Cake Design",
          "Raw materials and decorating tools",
          "Preparing the base cake and fillings",
          "Smoothing and covering the cake (ganache / buttercream)",
          "Fondant and covering techniques",
          "Buttercream decoration and patterns",
          "Crafting sugar roses and flowers",
          "Tiered cakes for weddings and special occasions",
          "Colors, painting and gold touches",
          "Presentation, photography and marketing",
